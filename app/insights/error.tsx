...
export default function InsightsError({
  ...
  useEffect(() => {
    console.error('[Insights Error Boundary]', error?.message ?? error);
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg font-semibold text-slate-100 mb-2">תובנות AI אינן זמינות</h2>
      <p className="text-sm text-slate-400 max-w-md mb-6">
        לא ניתן לטעון את היסטוריית החיזויים. הנתונים יוצגו לאחר שחזור החיבור.
      </p>
      {error?.message ? (
