...
function LoginForm() {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/5 bg-zinc-900/60 p-8 shadow-2xl backdrop-blur-xl sm:p-10">
      ...
      <div className="relative">
        <div className="mb-8 flex items-center justify-between border-b border-white/5 pb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[11px] uppercase tracking-[0.2em] text-zinc-400">Institution Access</p>
              <h1 className="text-lg font-semibold text-zinc-100">Terminal Authentication</h1>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            aria-label="Secure terminal login"
