...
export default function PortfolioError({
  ...
  useEffect(() => {
    console.error('[Portfolio Error Boundary]', error?.message ?? error);
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg font-semibold text-slate-100 mb-2">התיק הווירטואלי אינו זמין</h2>
      <p className="text-sm text-slate-400 max-w-md mb-6">
        לא ניתן לטעון את נתוני התיק. ייתכן שהחיבור למסד הנתונים כשל זמנית.
      </p>
      {error?.message ? (
