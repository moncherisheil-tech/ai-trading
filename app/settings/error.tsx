...
export default function SettingsError({
  ...
  useEffect(() => {
    console.error('[Settings Error Boundary]', error?.message ?? error);
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg font-semibold text-slate-100 mb-2">הגדרות אינן זמינות</h2>
      <p className="text-sm text-slate-400 max-w-md mb-6">
        מרכז הפיקוד נתקל בשגיאה. ייתכן שחיבור לבסיס הנתונים או לשרת נכשל.
      </p>
      {error?.message ? (
