...
export default function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 start-0 end-0 z-[var(--z-header)] bg-[#111111]/95 border-t border-white/10 backdrop-blur-xl shadow-[0_-1px_0_0_rgba(255,255,255,0.05)] pb-[env(safe-area-inset-bottom)] md:hidden"
      role="navigation"
