...
export default function ForexTicker({ collapsed }: { collapsed?: boolean }) {
  ...
  if (collapsed) {
    return (
      <div className={`${PANEL} px-2 py-1.5 text-[9px] font-mono tabular-nums text-cyan-200/90 text-center`} title="שער מט״ח">
        מט״ח
      </div>
    );
  }
  ...
  return (
    <div className={`${PANEL} px-3 py-2`} dir="ltr">
      <p className="text-[9px] font-bold uppercase tracking-[0.28em] text-cyan-500/70 mb-1">שער מט״ח חי</p>
