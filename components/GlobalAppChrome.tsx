...
export default function GlobalAppChrome({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <AppHeader />
      <div className={`flex flex-1 min-h-0 flex-col pt-20 md:pt-0 transition-[padding] duration-200 ${isRtl ? 'md:pe-[var(--app-sidebar-width,280px)]' : 'md:ps-[var(--app-sidebar-width,280px)]'}`}>
        <CryptoTicker />
