      ...
      <div className="relative overflow-hidden rounded-2xl">
        ...
        <div className="space-y-8 px-4 py-6 sm:px-6 sm:py-8">
                ...
                <div key={field.key} className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={cn(
                        'w-full rounded-xl border border-slate-700 bg-slate-950/80 py-2.5 ps-3 pe-10 text-sm text-slate-100 tabular-nums tracking-tight text-end',
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-800 bg-slate-950/50 px-4 py-3 text-xs text-slate-500">
            ...
            <div
              className="flex flex-wrap justify-end gap-x-4 gap-y-1 text-slate-400 tabular-nums text-end"
              dir="ltr"
            >
              <span>
